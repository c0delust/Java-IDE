    ...
    Private Sub Save_Click(sender As Object, e As EventArgs) Handles Save.Click
        ...
        Select Case (Form1.Caller)
            ...
            Case "DragDrop"
                Form1.SaveToolStripMenuItem_Click(Nothing, Nothing)
                Me.Close()
                If Form1.DialogR = 0 Then
                    Form1.Activate()
                    Me.Close()

                    Form1.filePath = Form1.Files(0)
                    Form1.fileName = Path.GetFileNameWithoutExtension(Form1.Files(0))
                    Form1.fileExt = Path.GetExtension(Form1.Files(0))
